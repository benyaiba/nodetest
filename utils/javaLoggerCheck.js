(function() {
    ...
    var walk = require('walk'), fs = require('fs'), path = require('path'), options, walker;
    var PATH = "C:\\gitWorkspace\\monoliths_admin\\monoliths_admin\\src\\main\\java"
    // var PATH = "C:\\gitWorkspace\\blade_manage\\src\\jp\\microad\\blade\"
    ...
    options = {
        listeners: {
            ...
            directories: function(root, dirStatsArray, next) {
                // dirStatsArray is an array of `stat` objects with the
